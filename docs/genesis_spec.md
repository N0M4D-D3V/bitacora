...
│   └── skills/
│       └── bitacora-cli/
│           └── SKILL.md                   # rendered adapter output
├── .opencode/
│   ├── agents/
│   │   ├── manager.md                     # adapter output
│   │   ├── coder.md
...
└── .agents/
    └── skills/
        └── bitacora-cli/
            └── SKILL.md                   # rendered adapter output (for Codex)
```
...
Outputs:
- `.claude/agents/{manager,coder,reviewer}.md` — generated from `.bitacora/agents/*.md` with Claude-Code-compatible frontmatter (tools/model as explicitly configured).
- `.claude/skills/bitacora-cli/SKILL.md` — rendered from `.bitacora/skills/bitacora-cli/SKILL.md`.
...
Outputs:
- `.opencode/agents/{manager,coder,reviewer}.md` — generated from canonical with OpenCode frontmatter.
- `.opencode/skills/bitacora-cli/SKILL.md` — rendered from `.bitacora/skills/bitacora-cli/SKILL.md`.
- Permissions are emitted only when explicit canonical permission metadata exists.

### 7.3 Codex (skill only)

Outputs:
- `.agents/skills/bitacora-cli/SKILL.md` — rendered from canonical.
...
- **AC-ADAPT-03** Generated adapter artifacts are deterministic physical files.
